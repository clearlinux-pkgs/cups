...
Version  : 2.2.4
Release  : 16
URL      : https://github.com/apple/cups/archive/v2.2.4.tar.gz
Source0  : https://github.com/apple/cups/archive/v2.2.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1498843886
export CC=clang
export CXX=clang++
export LD=ld.gold
unset LDFLAGS
