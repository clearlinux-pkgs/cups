...
Source2  : https://github.com/OpenPrinting/cups/releases/download/v2.4.2/cups-2.4.2-source.tar.gz.sig
Summary  : CUPS
...
%prep
%setup -q -n cups-2.4.2
cd %{_builddir}/cups-2.4.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664305230
