...
Source2  : https://github.com/OpenPrinting/cups/releases/download/v2.4.7/cups-2.4.7-source.tar.gz.sig
Summary  : CUPS
...
%prep
%setup -q -n cups-2.4.7
cd %{_builddir}/cups-2.4.7
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a cups-2.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695222165
